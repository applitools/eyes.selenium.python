...
class TestClassicAPI(TestSetup):
    ...
    def test_check_region(self):
        self.eyes.check_region_by_selector(By.ID, "overflowing-div", tag="Region", stitch_content=True)
...
class TestFluentAPI(TestSetup):
    ...
    def test_check_region_with_ignore_region_fluent(self):
        self.eyes.check("Fluent - Region with Ignore region", Target.region(By.ID, "overflowing-div")).ignore(Region(
            left=50, top=50, width=100, height=100)
        )
    ...
    def test_check_frame_in_frame_fully_fluent(self):
        self.eyes.check("Fluent - Full Frame in Frame", Target.frame("frame1").frame("frame1-1").fully())

    def test_check_region_in_frame_fluent(self):
        self.eyes.check("Fluent - Region in Frame in Frame",
    ...
    def test_check_frame_in_frame_fully_fluent2(self):
        ...
        self.eyes.check("Fluent - Full Frame in Frame 2", Target.frame("frame1").frame("frame1-1").fully())
    ...
    def test_check_window_with_floating_by_selector_fluent(self):
        self.eyes.check("Fluent - Window with floating region by selector",
    ...
    def test_check_element_fully_fluent(self):
        ...
        self.eyes.check("Fluent - Region by element - fully", Target.region(element).fully())
    ...
    def test_check_element_with_ignore_region_by_element_fluent(self):
        ...
        self.eye.check("Fluent - Region by element - fully", Target.region(element).ignore(ignore_element))
...
class ElementsFramesTest(TestSetup):
    ...
    def test_home1(self):
        ...
        self.eyes.check_region_in_frame_by_selector("frame1", By.ID, "inner-frame-div", "Inner frame div")

        element = self.driver.find_element(By.ID, "overflowing-div-image")
        self.eyes.check_region_by_element(element, "minions")

    def test_playbuzz(self):
        self.driver.get("http://alpha.playbuzz.com/plabuzz1010/automation-test-story-default")
        self.driver.find_element(By.CSS_SELECTOR,
                                 "#pb-story > pb-story > div > div.bottom-share-bar-container.ng-scope.ng-isolate-scope > button").click()
        self.eyes.check_region_by_selector(By.CSS_SELECTOR,
